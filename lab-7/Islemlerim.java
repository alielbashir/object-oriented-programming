...
public class Islemlerim {
     ...
     */
    public boolean buyuktur(double deger_2) {
        return deger_1 - deger_2 > e;
    }
    ...
    public boolean esittir(double deger_2) {
        // floating point hatasi oldugundan esitligi icin karsilastirirken
        // kontrol sayisini kullanmaya tercih ettim
        return Math.abs(deger_1 - deger_2) < e;
    }
}